...
Vamos aqui importar os dados de arquivos compartilhados o Google Drive. Vamos usar aqui arquivos que não precisam de autenticação. São aqueles que *" qualquer um com o link"*  podem acessar. Para isso terá que utilizar o pacote `googledrive`. 
