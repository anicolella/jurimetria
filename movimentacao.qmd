...
A plataforma fornece dados atualizados para os diversos segmentos da Justiça brasileira, agrupados e padronizados para permitir análises estatísticas e jurimétricas.
...
arquivos <- list.files("data/juri", full.names = TRUE, pattern = "rds$")

dados_basicos <- map_dfr(arquivos, readRDS)
